    ...
    return (
        <View testID="WelcomeScreen" style={FULL}>
            ...
            <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
                ...
                <Text style={CONTENT}>
                    This probably isn't what your app is going to look like. Unless your designer handed you this screen
                    and, in that case, congrats! You're ready to ship.
                </Text>
                <Text style={CONTENT}>
                    For everyone else, this is where you'll see a live preview of your fully functioning app using
                    Ignite.
                </Text>
            </Screen>
